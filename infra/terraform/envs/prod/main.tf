...
#   - Zone → DNS → Edit  on the knowledge-atoms.com zone
...
module "pages_project" {
  ...
  project_name          = "knowledge-atoms"
  production_branch     = "main"
  custom_domain         = "knowledge-atoms.com"
  zone_id               = var.zone_id
}
...
variable "zone_id" {
  description = "Cloudflare zone ID for knowledge-atoms.com."
  type        = string
}
